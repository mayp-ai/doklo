...
`0.2.0`은 Next.js App Router 전용 파서와 함께 범용 소스 분석을 제공합니다. Doklo는 개발자 프리뷰이며, 생성된 초안과 아래의 한계를 검토한 뒤 사용하십시오.
...
실패한 문서만 재개하거나 draft 상태로 도움말을 검토하려면 [생성 복구와 초안 검토](docs/ko/generation-review.md)를 참고하세요.
